...
def cadastro(request):
    ...
    if request.method == "GET":
        ...
        if senha != confirmar_senha:
            messages.add_message(request, constants.WARNING, 'Senhas não podem ser diferentes!')
            return render(request, 'cadastro.html')
        try:
            ...
            return render(request, 'cadastro.html', 'ocorreu um erro, procure o suporte tecnico.')
...
def logar(request):
    ...
    if request.method == "GET":
        ...
        if user is not None:
            ...
            messages.add_message(request, constants.ERROR, 'Usuario não localizado')
            return render(request, 'login.html')
